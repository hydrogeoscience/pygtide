...
! note on adaptability: the values are only written to the array
! if the total allocated length is not exceed. it is unclear what
! determines the length of text file output ...
